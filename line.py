...
def draw_line(image: Image.Image, point_1: Point, point_2: Point, line_color: Color):
...
# %%
def draw_line_2(image: Image.Image, point_1: Point, point_2: Point, line_color: Color):
...
# %%
def draw_line_3(image: Image.Image, point_1: Point, point_2: Point, line_color: Color):
    if point_1.x > point_2.x:
        point_1, point_2 = point_2, point_1
    gradient = (point_2.y - point_1.y) / (point_2.x - point_1.x)
    intercept = point_1.y - gradient * point_1.x
...
draw_line_2(image, Point(1, 1), Point(200, 200), line_color=white_color)
# %%
%%timeit

draw_line_3(image, Point(399, 20), Point(100, 150), line_color=white_color)
image
# %%

draw_line(image, Point(1, 1), Point(200, 200), line_color=white_color)
# %%
list(range(2, 0))
# %%
image
